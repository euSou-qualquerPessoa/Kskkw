...
function CheckQuest()
	...
	elseif World3 then
	  ...
	  elseif ((MyLevel == 2575) or (MyLevel <= 2599)) then
	    	...
	    	CFrameQuest = CFrame.new(-16665, 105, 1580)
	    	CFrameMon = CFrame.new(-16849.93, 147.00, 1640.88)
	 elseif MyLevel >= 2600 and MyLevel <= 2624 then
		...
		CFrameMon = CFrame.new(10736.619, -2087.844, 9338.488)
   elseif MyLevel >= 2625 and MyLevel <= 2649 then
		...
		CFrameQuest = CFrame.new(10882.264, -2086.322, 10034.226)
		CFrameMon = CFrame.new(10965.103, -2158.884, 9177.260)
	elseif MyLevel >= 2650 and MyLevel <= 2674 then
		...
		NameMon = "Sea Chanter"
		CFrameQuest = CFrame.new(10882.264, -2086.322, 10034.226)
		CFrameMon = CFrame.new(10621.034, -2087.844, 10102.033)
	elseif MyLevel >= 2675 and MyLevel <= 2699 then
		...
		CFrameQuest = CFrame.new(10882.264, -2086.322, 10034.226)
		CFrameMon = CFrame.new(11056.145, -2001.672, 10117.449)
	elseif MyLevel >= 2700 and MyLevel <= 2724 then
		Mon = "High Disciple"
		LevelQuest = 1
		NameQuest = "SubmergedQuest3"
		NameMon = "High Disciple"
		CFrameQuest = CFrame.new(9636.524, -1992.195, 9609.528)
		CFrameMon = CFrame.new(9828.088, -1940.909, 9693.064)
	elseif MyLevel >= 2725 then
		...
		CFrameQuest = CFrame.new(9636.524, -1992.195, 9609.528)
		CFrameMon = CFrame.new(9557.585, -1928.040, 9859.183)
	        end
      end
end
function Hop()
...
function CheckNearestTeleporter(v369)
	...
	local v374 = {};
	if (v373 == 2753915549 or 85211729168715) then
		v374 = {
	...
	elseif (v373 == 4442272183 or 79091703265657) then
		v374 = {
	...
	elseif (v373 == 7449423635 or 100117331123089) then
		v374 = {
...
v53:Button("Copy Discord Link", function()
	setclipboard("https://discord.gg/BnEDf68jwx");
end);
v53:Seperator("Time");
...
v54:Toggle("New Auto Farm Level [beta]", _G.Farm, function(v406)
	_G.Level = v406
	StopTween(_G.Farm)
end)
...
local function GoSubmerged()
	...
	repeat task.wait(0.5) until IsInSubmerged() or not _G.Level
	TravelingSubmerged = false
end

spawn(function()
	while wait() do
		if _G.Level and LocalPlayer.Data.Level.Value >= 2600 and not IsInSubmerged() then
			GoSubmerged()
		end
	end
end)
...
spawn(function()
	while wait() do
		if _G.Level and IsInSubmerged() then
			pcall(function()
				...
				if (game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false) then
					...
					CheckQuest()
					if BypassTP then
						if ((HRP().Position - CFrameQuest.Position).Magnitude > 3500) then
							BTP(CFrameQuest)
						else
							TP1(CFrameQuest)
						end
					...
					if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
						for _,v2831 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
							if v2831.Name == Mon and v2831:FindFirstChild("HumanoidRootPart") and v2831.Humanoid.Health > 0 then
								if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
									repeat
										...
										StartMagnet = true
									until not _G.Level or v2831.Humanoid.Health <= 0 or not v2831.Parent
								else
									StartMagnet = false
									game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
								end
	...
	if (_G.TeleFast == true) then
		repeat
			...
			elseif (_G.SelectFast == "Mansion") then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-12461.70, 375.05, -7554.58));
			elseif (_G.SelectFast == "Castle on the Sea") then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-5054.67, 314.56, -3181.21));
            elseif (_G.SelectFast == "Hydra") then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5659.43, 1013.08, -339.84));
            elseif (_G.SelectFast == "Temple of Time") then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(28286.36, 14896.55, 102.62));
			end
		until  not _G.TeleFast
	end
end);

v62:Seperator("Travels");
local Players = game:GetService("Players")
local RunService = game:GetService("RunService")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local LP = Players.LocalPlayer
...
local function StopFly()
	RunService:UnbindFromRenderStep("InstaTikiFly")
...
local function FlyTo(pos)
	...
	RunService:BindToRenderStep("InstaTikiFly", Enum.RenderPriority.Character.Value + 1, function()
		local hrp = HRP()
		...
		LV.VectorVelocity = dir * math.clamp(dist * 6, 200, 360)
		AO.CFrame = CFrame.lookAt(hrp.Position, hrp.Position + dir)
	end)
end

local function InstaTravelTiki()
	task.spawn(function()
		...
		FlyTo(Vector3.new(-5097.64, 316.51, -3178.52))
	end)
end

v62:Button("Travel Tiki", function()
	InstaTravelTiki()
end)
	...
	if (_G.TeleportIsland == true) then
		repeat
			...
			elseif (_G.SelectIsland == "Port Town") then
				topos(CFrame.new(-342.39, 20.65, 5535.41));
			elseif (_G.SelectIsland == "Castle On The Sea") then
				topos(CFrame.new( -5073, 315, -3153));
			elseif (_G.SelectIsland == "Hydra Island") then
				topos(CFrame.new(5294.54, 1005.39, 378.17));
			elseif (_G.SelectIsland == "Great Tree") then
				topos(CFrame.new(3016.34, 2280.6, -7337.57));
...
local function FlyTo(pos)
	...
	RunService:BindToRenderStep("BuyFly", Enum.RenderPriority.Character.Value + 1, function()
		...
		local dir = delta.Unit
		LV.VectorVelocity = dir * math.clamp(dist * 6, 120, 260)
		AO.CFrame = CFrame.lookAt(hrp.Position, hrp.Position + dir)
	end)
end
...
v63:Toggle("Buy Black Leg",false,function(v)_G.BuyFly=v if v then Buy("BlackLeg","BuyBlackLeg") else StopFly() end end)
v63:Toggle("Buy Electro",false,function(v)_G.BuyFly=v if v then Buy("Electro","BuyElectro") else StopFly() end end)
v63:Toggle("Buy Fishman Karate",false,function(v)_G.BuyFly=v if v then Buy("FishmanKarate","BuyFishmanKarate") else StopFly() end end)
v63:Toggle("Buy Superhuman",false,function(v)_G.BuyFly=v if v then Buy("Superhuman","BuySuperhuman") else StopFly() end end)
v63:Toggle("Buy Death Step",false,function(v)_G.BuyFly=v if v then Buy("DeathStep","BuyDeathStep") else StopFly() end end)
v63:Toggle("Buy Sharkman Karate",false,function(v)_G.BuyFly=v if v then Buy("SharkmanKarate","BuySharkmanKarate") else StopFly() end end)
v63:Toggle("Buy Electric Claw",false,function(v)_G.BuyFly=v if v then Buy("ElectricClaw","BuyElectricClaw") else StopFly() end end)
v63:Toggle("Buy Dragon Talon",false,function(v)_G.BuyFly=v if v then Buy("DragonTalon","BuyDragonTalon") else StopFly() end end)
v63:Toggle("Buy God Human",false,function(v)_G.BuyFly=v if v then Buy("GodHuman","BuyGodhuman") else StopFly() end end)
v63:Toggle("Buy Sanguine Art",false,function(v)_G.BuyFly=v if v then Buy("SanguineArt","BuySanguineArt") else StopFly() end end)
v63:Seperator(" Sword ");
